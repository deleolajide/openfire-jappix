package com.ifsoft.jappix.servlet;
...
import com.ifsoft.jappix.JappixPlugin;
...
public final class XMPPServlet extends WebSocketServlet
{
    ...
    public XMPPServlet() {
    	sockets = ( ( JappixPlugin) XMPPServer.getInstance().getPluginManager().getPlugin( "jappix" ) ).getSockets();
    }
